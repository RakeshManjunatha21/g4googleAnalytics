...
with tabs[0]:
    ...
    if geo is not None and not geo.empty:
        ...
        prompt = (
            ...
            "Provide data-driven recommendations to optimize engagement."
        )
        ...
        if act is not None and not act.empty and 'sessionMedium' in act.columns:
            ...
            prompt2 = (
                ...
                "Recommend optimization and budget reallocation."
            )
...
with tabs[1]:
    ...
    if lp is not None and not lp.empty:
        ...
        prompt = (
            ...
            "Suggest design and content improvements."
        )
...
with tabs[3]:
    ...
    if ins is not None and not ins.empty:
        ...
        prompt = (
            ...
            "Provide creative and targeting optimizations."
        )
...
with tabs[6]:
    ...
    if camps is not None and not camps.empty:
        ...
        prompt = (
            ...
            "Provide restructure recommendations."
        )
...
with tabs[8]:
    ...
    if ts is not None and not ts.empty:
        ...
        prompt = (
            ...
            "Provide funnel acceleration tactics."
        )
